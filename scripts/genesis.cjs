...
function generateEvolutionComponent(name, directive) {
  ...
  const materials = [
    ...
    `<MeshWobbleMaterial color="#3b82f6" emissive="#1d4ed8" emissiveIntensity={0.5 + balance * 2} roughness={0.2} metalness={0.8} factor={1} speed={2} />`,
    `<meshStandardMaterial color="#ec4899" emissive="#be185d" emissiveIntensity={0.5 + balance * 2} roughness={0.2} metalness={0.8} />`
  ];
