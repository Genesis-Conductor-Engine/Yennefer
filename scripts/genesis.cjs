...
function generateEvolutionComponent(name, directive) {
  ...
  const geometry = directiveStr.includes('box') || directiveStr.includes('cube') ? geometries[2] :
                   directiveStr.includes('sphere') || directiveStr.includes('orb') ? geometries[1] :
                   directiveStr.includes('torus') || directiveStr.includes('knot') ? geometries[0] :
                   directiveStr.includes('octahedron') ? geometries[3] :
                   directiveStr.includes('icosahedron') ? geometries[4] :
                   geometries[crypto.randomInt(geometries.length)];
  ...
  const material = directiveStr.includes('distort') ? materials[0] :
                   directiveStr.includes('wobble') ? materials[1] :
                   directiveStr.includes('standard') || directiveStr.includes('glow') ? materials[2] :
                   materials[crypto.randomInt(materials.length)];
